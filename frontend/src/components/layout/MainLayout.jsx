...
const NAV_ITEMS = [
  ...
  { path: "/products", label: "Produits / Producten", labelShort: "Produits", icon: Package },
  { path: "/clients", label: "Clients / Klanten", labelShort: "Clients", icon: History },
  { path: "/reports", label: "Rapports / Rapporten", labelShort: "Rapports", icon: FileText },
